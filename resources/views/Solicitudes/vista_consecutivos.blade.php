            ...
            <div>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="lista" style="padding:30px">
                    ...
                    <div class="alert alert-info" role="alert"  ng-show="mostrarFiltro == false && (searchSolSinRad.asunto_nuevo.nombre.length > 0 || searchSolSinRad.created_at.length > 0 || searchSolSinRad.estudiante.nombre.length > 0 || searchSolSinRad.estudiante.codigo.length > 0 || searchSolSinRad.nombreDependencia.length > 0)">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr ng-show="mostrarFiltro == true">
                            ...
                            <td><input type="text" ng-model="searchSolSinRad.nombreDependencia" name="nombreDependencia" id="nombreDependencia" class="form-control input-sm" id="inputSearch" maxlength="150" autocomplete="off"></td>
