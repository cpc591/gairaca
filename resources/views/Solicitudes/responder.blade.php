                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <ui-select multiple ng-model="respuesta.correosDependencias" theme="bootstrap">
                                        <ui-select-match placeholder="Seleccione Dependencia (múltiple)">@{{$item.nombre}}</ui-select-match>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <ui-select multiple ng-model="respuesta.correosDependenciasAdministrativas" theme="bootstrap">
                                        <ui-select-match placeholder="Seleccione Dependencia administrativa (múltiple)">@{{$item.nombre}}</ui-select-match>
