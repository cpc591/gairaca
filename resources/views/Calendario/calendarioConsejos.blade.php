...
@section('controller','ng-controller="calendarioConsejosCtrl"')
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ol class="breadcrumb">
                      ...
                      <li class="active">Calendario reuniones de consejo</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="/calendarioAgregarConsejos">Agregar nuevas fechas de consejo</a>
                </div>
