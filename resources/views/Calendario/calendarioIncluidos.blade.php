...
@section('controller','ng-controller="calendarioIncluidosCtrl"')
...
@section('contenido')
    <div class="container" ng-controller="calendarioIncluidosCtrl" ng-app="myApp">
            ...
            <div class="alert alert-info">
                ...
                <span class="messages">
                        <span>Ayuda</span><br/>
                        <span>En este calendario se encuentran los días que han sido incluidos como días laborales.</span><br>
                </span>
            </div>
