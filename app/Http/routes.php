...
Route::get('/calendarioAgregarConsejos', 'CalendarioController@calendarioAgregarConsejos');
Route::get('/calendarioConsejos', 'CalendarioController@calendarioConsejos');
Route::get('/calendarioPublicoConsejos/{id}', 'PublicCalendarioConsejoController@calendarioPublicoConsejos');
...
Route::post('/agregarFechasExcluidos', 'CalendarioController@agregarFechasExcluidos');
Route::get('/fechasCalendario', 'CalendarioController@fechasCalendario');
Route::get('/fechasCalendarioConsejos', 'CalendarioController@fechasCalendarioConsejos');
Route::get('/fechasCalendarioConsejosEstudiantes/{id}', 'PublicCalendarioConsejoController@fechasCalendarioConsejosEstudiantes');
Route::post('/fechasAgregarConsejos', 'CalendarioController@agregarFechasConsejos');
...
Route::post('/rechazarRespuesta', 'RadicacionController@rechazarRespuesta');
...
Route::get('/getListadoConsejos', 'PublicCalendarioConsejoController@getListadoConsejos');
