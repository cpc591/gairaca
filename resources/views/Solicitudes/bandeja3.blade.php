                  ...
                  <div class="col-xs-12">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      @if(Auth::user()->id == 39)
                        ...
                        <li role="calendarioConsejos" ><a href="/calendario" aria-controls="calendarioConsejos">Calendario días laborales</a></li>
                      @endif
                      <li role="calendarioConsejos" ><a href="/calendarioConsejos" aria-controls="calendarioConsejos">Calendario de consejo</a></li>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="lista" style="padding:30px">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr dir-paginate="x in listado_solicitudes_dependencias | filter:search | itemsPerPage:10" pagination-id="paginacion_solicitudes"  ng-if="(x.accion_id!=7 || x.accion_id != 8)" ng-class="{'danger':((x.alertaDuracion<=3  && x.alertaDuracion>=0) || x.alertaDuracion<0 && x.accion_id!=7 && x.accion_id!=2) && {{Auth::user()->id}} == 39, 'warning':x.alertaDuracion<=6 && x.alertaDuracion>=4 && x.accion_id!=7 && x.accion_id!=2 && {{Auth::user()->id}} == 39,'success':x.alertaDuracion>6 && x.accion_id!=7 && x.accion_id!=2 && {{Auth::user()->id}} == 39}">
                            <td>@{{x.consecutivo}}</td>
                            <td>
