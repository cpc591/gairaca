...
<html>
    ...
    #footer2 { position: fixed; bottom: -140px; height: 150px; width:100%}
    ...
    <body>
        <div class="row" id="header2">
            <div class="xs-12">
                <img style="text-align:left" src="img/headers/header_{{$user_id}}.jpg" width="100%"/>    
            </div>
        </div>
        <div class="row" id="footer2">
            ...
            <div class="xs-12" style="text-align:center">
                <img  src="img/footers/footer_{{$user_id}}.jpg"/>   
            </div>
        </div>
