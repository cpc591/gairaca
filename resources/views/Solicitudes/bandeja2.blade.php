                          ...
                          <div class="row" ng-if="errores != null">
                            ...
                            <form role="form" name="formCrear"  novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <label><span class="asterisco">*</span>Dependencia</label>
                                        <select class="form-control" name="dependencia" id="depenencia" ng-change="descripcion_asunto = null" ng-options="dependencia as dependencia.nombre for dependencia in dependencias" ng-model="solicitud.Dependencia" ng-required="true">
                                ...
                                <div class="row">
                                    <div class="col-md-12  col-xs-12 col-sm-12">
                                        <label><span class="asterisco">*</span>Asunto</label>
                                        <input ng-if="solicitud.Dependencia.asuntos.length == 0" type="text" name="Asunto" class="form-control" ng-model="solicitud.Asunto" ng-required="true" />
                                        <select ng-if="solicitud.Dependencia.asuntos.length > 0" ng-change="buscar_descripcion()" class="form-control" name="asunto" id="asunto" ng-options="asunto.id as asunto.nombre for asunto in solicitud.Dependencia.asuntos" ng-model="solicitud.asunto" ng-required="true">
                                            <option value="">Seleccione un asunto</option>
                                        </select>
                                        <div class="row">
                                          <div class="col-md-12 col-sm-12 col-xs-12">
