...
@section('Title','Aprobación Director académico')
@section('app','ng-app="appDirectorAcademico"')
@section('controller','ng-controller="aprobar_vista_academicoCtrl"')
                            ...
                            <form role="form" name="formCrear"  novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-xs-12 col-sm-12">
                                        <div class="alinea_load"><label><span class="asterisco">*</span>Código</label></div>
                                            <input type="text" name="Estudiante" class="form-control" ng-model="estudiante.codigo" ng-required="true" readonly />
